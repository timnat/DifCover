...
#define max_cov 100000 // Default value for upper limit on depth of coverage
...
int main( int argc , char** argv ) {
   ...
   cout<<"Usage: program *.unionbedcv a A b B v l"<<endl;
	...
	if(scaf_pred != scaf) 
	  ...
	  if(av_sum_k1 == 0 && av_sum_k2 == 0) 
		  ...
		  if(av_sum_k2 == 0) av_sum_k2=(av_sum_k1<CC0)?av_sum_k1:CC0;   // sample1 >=a and sample2 == 0
            	  ratio=(float)((int)((av_sum_k1/av_sum_k2)*1000))/1000;
	       }
